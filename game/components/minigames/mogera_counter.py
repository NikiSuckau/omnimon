...
class MogeraCounter:
    ...
    def update_active(self):
        ...
        pet_x = constants.SCREEN_WIDTH - pet_size - int(20 * constants.UI_SCALE)
        ...
        if self.attack_x >= pet_x and not self.has_countered_current:
            ...
            pet_y = constants.SCREEN_HEIGHT // 2 - pet_size // 2
        ...
        if self.is_counter_attack_moving:
            ...
            counter_sprite_width = self.counter_attack_sprite.get_width() if self.counter_attack_sprite else int(24 * constants.UI_SCALE)
            current_attack = self.attacks[self.current_attack_index]
            ...
            elif self.counter_attack_x < int(20 * constants.UI_SCALE):
        ...
        if self.has_countered_current and self.hit_animation_timer == 0 and not self.is_counter_attack_moving:
            ...
            should_next = True
        elif not self.has_countered_current and self.attack_x > constants.SCREEN_WIDTH:
