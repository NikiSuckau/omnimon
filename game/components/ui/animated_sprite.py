...
class AnimatedSprite(UIComponent):
    ...
    def __init__(self, ui_manager):
        ...
        super().__init__(0, 0, constants.SCREEN_WIDTH, constants.SCREEN_HEIGHT)
    ...
    def _create_blurred_overlay(self, sprite, cache_key):
        ...
        current_screen_size = (constants.SCREEN_WIDTH, constants.SCREEN_HEIGHT)
    ...
    def _render_frame(self, frame_index):
        ...
        # Create cache key
        cache_key = (frame_index, bg_color, constants.SCREEN_WIDTH, constants.SCREEN_HEIGHT)
        ...
        if overlay:
            overlay_rect = overlay.get_rect(center=(constants.SCREEN_WIDTH // 2, constants.SCREEN_HEIGHT // 2))
            surface.blit(overlay, overlay_rect)
        
        # Draw centered sprite
        if sprite:
            sprite_rect = sprite.get_rect(center=(constants.SCREEN_WIDTH // 2, constants.SCREEN_HEIGHT // 2))
